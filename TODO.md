...
Current version: `0.6.1` (see `moon.mod`).
...
1. Keep GitHub issues and release docs aligned with the current `416 / 416` baseline; stale issue bodies should not be used as the source of truth over this file.
