...
- **Eval gold-match**: 277 / 391 PCF fixtures byte-for-byte against upstream (70.8%)
...
- `generators`: 16 / 21 with-gold fixtures pass. Untyped element / entry generators, predicate members, and Dynamic / Listing / Mapping spread syntax are done; typed generators and lexical-scope cases remain.
