...
- **Eval gold-match**: 279 / 391 PCF fixtures byte-for-byte against upstream (71.4%)
...
- `generators`: 18 / 21 with-gold fixtures pass. Element / entry generators, typed generator binding checks, predicate members, and Dynamic / Listing / Mapping spread syntax are done; function-body, mixin, and lexical-scope generator cases remain.
