...
- **Eval gold-match**: 275 / 391 PCF fixtures byte-for-byte against upstream (70.3%)
...
- `generators`: 14 / 21 with-gold fixtures pass. Predicate members and Dynamic / Listing / Mapping spread syntax are done; typed element / entry generators still need broader shape-aware object-body evaluation.
