...
- **Eval gold-match**: 130 PCF + 1 JSON + 1 plist fixtures byte-for-byte against upstream
...
CI (`.github/workflows/ci.yml`) runs the same gate on every push / PR. 163 implemented pkspec scenarios; see `SPEC.md` for the full rendered spec.
