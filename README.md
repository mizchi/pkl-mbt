...
- **Eval gold-match**: 285 / 391 PCF fixtures byte-for-byte against upstream (72.9%)
...
- `basic`: 73 / 86 with-gold fixtures pass. Remaining DIFFs cluster around `as` edge cases, numeric and Bytes parity, and const / `outer` provenance.
