...
As of the `PKL-050` spec slice, this project has 50 implemented pkspec scenarios. The next tracked slice is `PKL-051`, which preserves constrained typealias metadata.
...
This is not a full Pkl implementation yet. The next compatibility work is `PKL-051` constrained typealias metadata, followed by broader Pkl type/stdlib coverage and class/object semantics.
