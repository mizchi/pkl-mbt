...
As of the `PKL-058` spec slice, this project has 58 implemented pkspec scenarios. The next tracked slice is `PKL-059`, which enforces constrained class property default values.
...
This is not a full Pkl implementation yet. The next compatibility work is `PKL-059` constrained class property default values, followed by broader Pkl type/stdlib coverage and class/object semantics.
