...
- **Eval gold-match**: 110 PCF + 1 JSON + 1 plist fixtures byte-for-byte against upstream
...
CI (`.github/workflows/ci.yml`) runs the same gate on every push / PR. 151 implemented pkspec scenarios; see `SPEC.md` for the full rendered spec.
