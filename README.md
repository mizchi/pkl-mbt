...
- **Eval gold-match**: 150 PCF + 1 JSON + 1 plist fixtures byte-for-byte against upstream
...
CI (`.github/workflows/ci.yml`) runs the same gate on every push / PR. 179 implemented pkspec scenarios; see `SPEC.md` for the full rendered spec.
