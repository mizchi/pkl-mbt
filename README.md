...
- **Eval gold-match**: 315 / 391 PCF fixtures byte-for-byte against upstream (80.6%)
...
- `basic`: 80 / 86 with-gold fixtures pass. Numeric / Bytes / nullable parity is gold-matching; remaining DIFFs cluster around `as`, `new`, amend-chain, underscore, and const / `outer` provenance.
