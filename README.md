...
- **Eval gold-match**: 321 / 391 PCF fixtures byte-for-byte against upstream (82.1%)
...
- `basic`: 82 / 86 with-gold fixtures pass. Numeric / Bytes / nullable / `new` parity is gold-matching; remaining DIFFs cluster around `as`, amend-chain, underscore, and const provenance.
