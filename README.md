...
- **Eval gold-match**: 283 / 391 PCF fixtures byte-for-byte against upstream (72.4%)
...
- `basic`: 71 / 86 with-gold fixtures pass. Remaining DIFFs cluster around `as` edge cases, numeric and Bytes parity, read/resource host behavior, and const / `outer` provenance.
