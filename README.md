...
- **Eval gold-match**: 297 / 391 PCF fixtures byte-for-byte against upstream (76.0%)
- **Renderer gold-match**: JSON 1, plist 1, textproto 1, XML 6 upstream renderer fixtures byte-for-byte against upstream
