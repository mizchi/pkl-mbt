...
43 tests across 2 module(s) — 39 pending, 4 active
...
- [ ] **support Pkl qualified class inheritance types** [draft] — verifies: PKL-039 — tags: parser, typechecker, imports, next
