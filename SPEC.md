...
248 tests across 2 module(s) — 183 pending, 65 active
...
- **PKL-148ac** — module-level super dispatch for extends
  - test: `specs/Test.pkl` — upstream apple pkl fixture smoke
- **PKL-148ad** — super late binding amend lambda form class-aware object equality
