...
55 tests across 2 module(s) — 51 pending, 4 active
...
- [ ] **preserve Pkl constrained typealias metadata** [draft] — verifies: PKL-051 — tags: typechecker, evaluator, next
