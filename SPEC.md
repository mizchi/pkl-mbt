...
245 tests across 2 module(s) — 180 pending, 65 active
...
- [ ] **super late binding amend lambda form class-aware object equality** [draft] — verifies: PKL-148y — tags: evaluator, stdlib, upstream, compat, next
