...
56 tests across 2 module(s) — 52 pending, 4 active
...
- [ ] **evaluate Pkl constrained typealias object member annotations** [draft] — verifies: PKL-052 — tags: evaluator, typechecker, next
