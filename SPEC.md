...
53 tests across 2 module(s) — 49 pending, 4 active
...
- [ ] **propagate Pkl constrained callable metadata through higher-order calls** [draft] — verifies: PKL-049 — tags: typechecker, next
