...
45 tests across 2 module(s) — 41 pending, 4 active
...
- [ ] **evaluate Pkl class method invocations** [draft] — verifies: PKL-041 — tags: evaluator, typechecker, next
