...
252 tests across 2 module(s) — 187 pending, 65 active
...
- **PKL-148ag** — object-body local function and unknown-type diagnostic
  - test: `specs/Test.pkl` — upstream apple pkl fixture smoke
- **PKL-148ah** — super late binding amend lambda form class-aware object equality
