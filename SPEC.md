...
251 tests across 2 module(s) — 186 pending, 65 active
...
- **PKL-148af** — callable arg type rejection walks collection elements
  - test: `specs/Test.pkl` — upstream apple pkl fixture smoke
- **PKL-148ag** — super late binding amend lambda form class-aware object equality
