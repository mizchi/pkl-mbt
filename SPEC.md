...
38 tests across 2 module(s) — 34 pending, 4 active
...
- [ ] **infer Pkl class property default types** [draft] — verifies: PKL-034 — tags: typechecker, next
