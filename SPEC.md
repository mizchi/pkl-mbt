...
44 tests across 2 module(s) — 40 pending, 4 active
...
- [ ] **model Pkl class method declarations** [draft] — verifies: PKL-040 — tags: parser, typechecker, next
