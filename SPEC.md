...
68 tests across 2 module(s) — 64 pending, 4 active
...
- [ ] **evaluate Pkl class method return annotations** [draft] — verifies: PKL-064 — tags: evaluator, class, next
