...
69 tests across 2 module(s) — 65 pending, 4 active
...
- [ ] **evaluate constrained Pkl callable return annotations** [draft] — verifies: PKL-065 — tags: evaluator, callable, typechecker, next
