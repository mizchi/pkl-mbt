...
46 tests across 2 module(s) — 42 pending, 4 active
...
- [ ] **evaluate Pkl function declarations lambdas and calls** [draft] — verifies: PKL-042 — tags: evaluator, next
