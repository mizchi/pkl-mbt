...
41 tests across 2 module(s) — 37 pending, 4 active
...
- [ ] **evaluate Pkl typed object class defaults** [draft] — verifies: PKL-037 — tags: evaluator, next
