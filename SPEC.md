...
246 tests across 2 module(s) — 181 pending, 65 active
...
- **PKL-148aa** — super property access in class default body
  - test: `specs/Test.pkl` — upstream apple pkl fixture smoke
- **PKL-148ab** — super late binding amend lambda form class-aware object equality
