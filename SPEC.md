...
249 tests across 2 module(s) — 184 pending, 65 active
...
- **PKL-148ad** — at-prefix local dep import resolution
  - test: `specs/Test.pkl` — upstream apple pkl fixture smoke
- **PKL-148ae** — super late binding amend lambda form class-aware object equality
