...
67 tests across 2 module(s) — 63 pending, 4 active
...
- [ ] **evaluate Pkl callable return annotations** [draft] — verifies: PKL-063 — tags: evaluator, callable, next
