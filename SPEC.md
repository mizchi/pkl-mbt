...
247 tests across 2 module(s) — 182 pending, 65 active
...
- **PKL-148ab** — class methods bare-name resolution in class default body
  - test: `specs/Test.pkl` — upstream apple pkl fixture smoke
- **PKL-148ac** — super late binding amend lambda form class-aware object equality
